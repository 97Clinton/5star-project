  ...
  const Routes = [
    {
      ...
      icon: (
        <svg
          ...
          viewBox="0 0 24 24"
          strokeWidth="1.5"
          stroke={pathname === "/app/home" ? "#064e3b" : "currentColor"}
          className="w-6 h-6"
        >
          <path
            strokeLinecap="round"
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          viewBox="0 0 24 24"
          strokeWidth="1.5"
          stroke={pathname === "/app/members" ? "#064e3b" : "currentColor"}
          className="w-6 h-6"
        >
          <path
            strokeLinecap="round"
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          viewBox="0 0 24 24"
          strokeWidth="1.5"
          stroke={pathname === "/app/settings" ? "#064e3b" : "currentColor"}
          className="w-6 h-6"
        >
          <path
            strokeLinecap="round"
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          strokeWidth="1.5"
          stroke={
            pathname === "/app/create_new_app" ? "#064e3b" : "currentColor"
          }
          className="w-6 h-6"
        >
          <path
