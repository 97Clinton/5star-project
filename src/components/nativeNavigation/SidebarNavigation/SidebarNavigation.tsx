        ...
        <div className="sidebarNavigation">
            <div className="content">
                ...
                <p>
                    ...
                    highly configurable. Users access the navigation meny through a "hamburger" 
                    toogle button if a Top Nav Bar is enabled, or by sliding from the left side 
                    of the screen. The menu items in the sidebar nav menu can be configured with 
                    an optional icon and in collapsible groupings. The sidebar menu items can be 
                    configured within the app configuration as well as set dynamically via the 
                    JavaScript Bridge.
                </p>
                    ...
                    <div className="box">
                        <div className="left">
                            ...
                            <form className="radioGroup">
                                <div className="form-check">
                                  <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1" />
                                  <label className="form-check-label" htmlFor="inlineRadio1">App</label>
                                </div>
                                <div className="form-check">
                                  <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2" />
            ...
            <div className="final content">
                ...
                <p>
                    ...
                    group by dragging to the right within the visual editor. Note that icons 
                    are optional in sidebar menus.
                </p>
                <div className="buttons">
                    <h6><i className="fa-solid fa-rotate"></i> Restore Defaults</h6>
                    <h6><i className="fa-solid fa-trash-can"></i> Clear All</h6>
                </div>
                    ...
                    <div className="mini">
                        <div className="miniContent">
                            ...
                            <div className="flexBottom">
                                ...
                                <input type="url" name="url" id="urlInput" placeholder="https://webhosting.5starcom" />
